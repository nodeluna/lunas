...
#define SSH_AUTH_METHOD_PUBLICKEY_COMBO_1 (SSH_AUTH_METHOD_PUBLICKEY | SSH_AUTH_METHOD_HOSTBASED)
#define SSH_AUTH_METHOD_PUBLICKEY_COMBO_2 (SSH_AUTH_METHOD_PUBLICKEY | SSH_AUTH_METHOD_INTERACTIVE)
#define SSH_AUTH_METHOD_PUBLICKEY_COMBO_3 (SSH_AUTH_METHOD_PUBLICKEY | SSH_AUTH_METHOD_GSSAPI_MIC) 
#define SSH_AUTH_METHOD_PUBLICKEY_COMBO_4 (SSH_AUTH_METHOD_PUBLICKEY | SSH_AUTH_METHOD_INTERACTIVE | SSH_AUTH_METHOD_GSSAPI_MIC)
#define SSH_AUTH_METHOD_PUBLICKEY_COMBO_5 (SSH_AUTH_METHOD_PUBLICKEY | SSH_AUTH_METHOD_INTERACTIVE | SSH_AUTH_METHOD_HOSTBASED)
#define SSH_AUTH_METHOD_PUBLICKEY_COMBO_6 (SSH_AUTH_METHOD_PUBLICKEY | SSH_AUTH_METHOD_GSSAPI_MIC | SSH_AUTH_METHOD_HOSTBASED)
#define SSH_AUTH_METHOD_PUBLICKEY_COMBO_7 (SSH_AUTH_METHOD_PUBLICKEY | SSH_AUTH_METHOD_INTERACTIVE | SSH_AUTH_METHOD_HOSTBASED | SSH_AUTH_METHOD_GSSAPI_MIC)
